#undef PROCEDURALFIRSTPERSONANIMATIONSYSTEM_API
...
#define UE_PROJECT_NAME ShooterUE
#define UE_TARGET_NAME ShooterUEEditor
...
#define PROCEDURALFIRSTPERSONANIMATIONSYSTEM_API DLLEXPORT
